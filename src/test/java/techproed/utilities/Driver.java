...
public class Driver {
    ...
    Driver class indan obje olusturmanin onune gecmek icin burdaki public olan gizli constructor i private yaptik
    boylece driver class indan obje olustrumanin onune gectik
     */
    private Driver(){
